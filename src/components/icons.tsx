...
function defaults(props: IconProps, fallback = "h-6 w-6") {
  return { ...props, className: props.className ?? fallback };
}
...
export function CheckIcon(props: IconProps) {
  const p = defaults(props, "h-3.5 w-3.5");
  return (
    <svg {...p} viewBox="0 0 20 20" fill="currentColor" aria-hidden>
      <path
        fillRule="evenodd"
...
export function ChevronDownIcon(props: IconProps) {
  const p = defaults(props, "h-5 w-5");
  return (
    <svg {...p} viewBox="0 0 20 20" fill="currentColor" aria-hidden>
      <path
        fillRule="evenodd"
...
export function ArrowDownIcon(props: IconProps) {
  const p = defaults(props);
  return (
    <svg {...p} viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth={1.5} aria-hidden>
...
/* ------------------------------------------------------------------ */
/*  Lookup map — maps string keys from siteContent to icon components  */
/* ------------------------------------------------------------------ */
