...
export function ImagePlaceholder({
  ...
  return (
    <figure className="overflow-hidden rounded-2xl border border-gray-200 bg-white shadow-sm">
      <div className={`relative ${ratioClasses[ratio]} overflow-hidden`}>
        {src ? (
          <img
            src={src}
            alt={title}
          ...
          <>
            <div className="absolute inset-0 bg-gradient-to-br from-[var(--brand-blue)]/8 via-gray-50 to-[var(--brand-red)]/8" />
      ...
      <figcaption className="space-y-1 border-t border-gray-200 bg-gray-50 px-4 py-3">
        <p className="text-xs font-semibold uppercase tracking-wider text-gray-500">
          {src ? "Image source" : "Suggested path"}
        </p>
